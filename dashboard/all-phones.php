        ...
        <div id="page-content-wrapper">
            ...
            ?>
                      <tr>
                        ...
                        <td>
                            <a href="../single-phone.php?id=<?php echo $fetch_phone_data['phone_id'] ?>" class="btn btn-outline-primary btn-sm">View</a>
                            <a href="all-phones-update.php?id=<?php echo $fetch_phone_data['phone_id'] ?>" class="btn btn-outline-warning btn-sm">Edit</a>
