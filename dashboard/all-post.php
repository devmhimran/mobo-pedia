                ...
                <table class="table mt-3">
                    ...
                    ?>
                      <tr>
                        ...
                        <td><img style="width: 50px" src="./assets/post/<?php echo $fetch_post_data['featured_photo'] ?>" alt=""></td>
                        <td colspan="2"><?php echo $fetch_post_data['post_title'] ?></td>
                        <td>
                            <a href="../singe-post.php?id=<?php echo $fetch_post_data['post_id'] ?>" class="btn btn-outline-primary btn-sm">View</a>
